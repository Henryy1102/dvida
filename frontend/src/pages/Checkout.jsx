  ...
  const handleCrearOrden = async () => {
    ...
    if (paso === 3) {
      ...
      if (!ubicacion || !ubicacion.link || ubicacion.link.trim() === "") {
        setError("Por favor ingresa tu ubicación para generar el enlace de OpenStreetMap");
        return;
      }
    ...
    if (paso === 4) {
      try {
        ...
        if (!ubicacion || !ubicacion.link || ubicacion.link.trim() === "") {
          setError("Por favor ingresa tu ubicación para generar el enlace de OpenStreetMap antes de confirmar");
          return;
        }
  ...
  return (
    <div style={{background: '#ffffff', minHeight: '100vh'}}>
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        {/* Encabezado */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2" style={{color: '#000000'}}>Checkout</h1>
          <p style={{color: '#0052a3'}}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2">
                  ...
                  <button
                    ...
                    className={`p-6 rounded-lg border-2 transition-all ${
                      requiereFactura === false
                        ? "border-amber-500 bg-gray-500/10"
            ...
            {/* Paso 3: Ubicación con OpenStreetMap */}
            {paso === 3 && (
              <div className="bg-white rounded-lg shadow-md p-6 border border-gray-300">
            ...
            {paso === 4 && (
              <div className="bg-white rounded-lg shadow-md p-6 border border-gray-300">
                    ...
                    <div className="bg-blue-50 border-2 border-blue-500 rounded-lg p-6">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="text-blue-800 space-y-3 text-sm">
                            ...
                            <div className="mt-4 bg-blue-50 border border-yellow-300 rounded p-3">
                      ...
                      <div className="mt-6 border-t border-blue-300 pt-6">
                        ...
                        {metodoPago === "transferencia" && !comprobante && (
                          <p className="text-sm text-blue-600 mt-2">⚠️ Debes subir el comprobante para continuar</p>
                        )}
                      </div>
                    </div>
                  )}
                ...
                <div className="mt-8 p-4 bg-white/30 rounded-lg border border-gray-300">
          ...
          <div className="md:col-span-1">
            <div className="bg-white rounded-lg shadow-md p-6 sticky top-4 border border-gray-300">
              ...
              <button
                ...
                disabled={cargando}
                className="w-full bg-primary text-white py-3 rounded-lg font-semibold hover:bg-primary/90 disabled:bg-gray-600 disabled:text-gray-300 mb-3"
              >
              ...
              {paso > 1 && (
                <button
                  ...
                  disabled={cargando}
                  className="w-full bg-white/50 text-accent py-2 rounded-lg font-semibold hover:bg-white/70 border border-gray-300 disabled:bg-gray-700"
                >
                  Atrás
                </button>
              )}
