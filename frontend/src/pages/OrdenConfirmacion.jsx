    ...
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-white py-8 print:bg-white">
      <div className="container mx-auto px-4 max-w-2xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mb-4">Gracias por tu compra en d'vida</p>
          <p className="text-2xl font-bold text-blue-600">{numeroOrden}</p>
        </div>
        ...
        <div className="bg-blue-50 border border-gray-300 rounded-lg p-4 print:hidden">
