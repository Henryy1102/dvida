        ...
        <div className="grid gap-6">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  className="w-full bg-fondo text-accent border border-primary/30 rounded px-3 py-2 focus:outline-none focus:border-primary"
                  placeholder="Ej: contacto@aguadevida.com"
                />
              </div>
            </div>
          </div>
          ...
          <div className="flex gap-4">
            <button
              onClick={handleSave}
              disabled={saving}
              className="bg-primary text-white px-6 py-3 rounded font-semibold hover:bg-primary/90 transition disabled:bg-primary/50"
            >
            ...
            <button
              ...
              disabled={saving}
              className="bg-accent text-white px-6 py-3 rounded font-semibold hover:bg-accent/90 transition"
            >
              🔄 Recargar
            </button>
          </div>
