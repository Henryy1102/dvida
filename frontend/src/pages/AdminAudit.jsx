...
export default function AdminAudit() {
  ...
  const getAccionColor = (accion) => {
    ...
    if (accion.includes("COMPRA")) return "bg-orange-600/15 text-orange-300 border border-red-200/30";
    return "bg-slate-700/40 text-subtext border border-sky-100";
  };
  ...
  return (
    <div className="min-h-screen bg-fondo">
      <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-12 max-w-7xl">
        {/* Header */}
        <div className="bg-secondary border border-sky-100 rounded-card p-8 sm:p-12 mb-8 text-center">
        ...
        {/* Tabla de Logs */}
        <div className="bg-secondary rounded-card overflow-hidden border border-sky-100">
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-secondary border-b border-sky-100">
                <tr>
          ...
          {/* Paginación */}
          {totalPages > 1 && (
            <div className="bg-secondary px-4 py-3 border-t border-sky-100 flex items-center justify-between">
