              ...
              >
                <div className="flex flex-wrap items-start justify-between gap-4">
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-accent text-sm mb-1">TOTAL:</p>
                  ...
                  <div className="flex flex-col gap-2 min-w-[150px]">
                    ...
                    <button
                      ...
                      className="bg-primary text-white px-4 py-2 rounded-lg hover:bg-primary/90 transition font-semibold"
                    >
                      📥 Descargar PDF
                    </button>
                  </div>
                      ...
                      <table className="w-full">
                        ...
                        <tbody>
                          {factura.productos.map((producto, index) => (
                            <tr
                              key={index}
                              className="border-b border-primary/10 bg-slate-50"
                            >
